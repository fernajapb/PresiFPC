...
const FONDO_SIN_LICENCIA = "https://img.freepik.com/vector-premium/fondo-futbol-o-futbol-pelota-grande-colores-azules_444390-18092.jpg";
const FONDO_CON_LICENCIA = "https://i.pinimg.com/736x/46/5c/70/465c700b151ca3163244ba392ed0213d.jpg";
...
const data = JSON.parse(event.target.result);
  ...
  if (firmaCalculada === data.firma) {
    ...
    actualizarFondo();
    alert("✅ Licencia válida - Fotos desbloqueadas");
  } else {
    alert("❌ Licencia falsa o modificada");
  }
