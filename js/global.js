...
//EQUIPOS DE PRIMERA 
let equiposPrimera = [
  { nombre: "Nacional", fuerza: 78 },
  { nombre: "Millonarios", fuerza: 75 },
  { nombre: "América", fuerza: 76 },
  { nombre: "Cali", fuerza: 70 },
  { nombre: "Junior", fuerza: 76 },
  { nombre: "Santa Fe", fuerza: 73 },
  { nombre: "Tolima", fuerza: 74 },
  { nombre: "Medellín", fuerza: 74 },
  { nombre: "Once Caldas", fuerza: 71 },
  { nombre: "Pereira", fuerza: 69 },
  { nombre: "Alianza", fuerza: 67 },
  { nombre: "Bucaramanga", fuerza: 70 },
  { nombre: "Inter Bogotá", fuerza: 68 },
  { nombre: "Jaguares", fuerza: 65 },
  { nombre: "Pasto", fuerza: 66 },
  { nombre: "Águilas", fuerza: 69 },
  { nombre: "B.Chico", fuerza: 64 },
  { nombre: "Fortaleza", fuerza: 67 },
  { nombre: "Llaneros", fuerza: 64 },
  { nombre: "Cucuta", fuerza: 64 }
];
...
function calcularPresupuestoPorFuerza(fuerza) {
  if (fuerza >= 78) return 30000000;
  if (fuerza >= 75) return 25000000;
  if (fuerza >= 73) return 20000000;
  if (fuerza >= 69) return 17000000;
  if (fuerza >= 66) return 14000000;
  if (fuerza >= 64) return 10000000;
  if (fuerza >= 60) return 7000000;
  return 5000000;
}

function calcularSueldoPorFuerza(fuerza) {
  const presupuesto = calcularPresupuestoPorFuerza(fuerza);
  const PORCENTAJE_SUELDOS = 0.15; // 15%

  return Math.round(presupuesto * PORCENTAJE_SUELDOS);
}
